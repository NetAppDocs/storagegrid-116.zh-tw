...
儘管 StorageGRID 負載平衡器服務是建議的負載平衡機制，但您也可以選擇整合第三方負載平衡器。有關資訊，請聯繫您的 NetApp 客戶代表或參閱 https://www.netapp.com/pdf.html?item=/media/17068-tr4626.pdf["TR-4626：StorageGRID 不包括第三方和全域負載平衡器"^]。
